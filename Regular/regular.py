'''
@Author: ralph
@Date: 2020-07-24 15:16:30
@LastEditTime: 2020-07-24 18:09:16
@LastEditors: Please set LastEditors
@Description: 正则表达式
@FilePath: \python\workbeach\Regular\re_module.py
...
# 匹配整数或者小数（包括正数和负数）
-?([0-9]\d*.\d*|0.\d*[0-9]\d*|[0-9])
-?\d+(\.\d+)?

#匹配年月日日期 格式2018-12-6（*）
^[1-9]\d{3}(\-|\/|.)(1[0-2]|0?[1-9])\1(3[01]|[12]\d|0?[1-9])$
